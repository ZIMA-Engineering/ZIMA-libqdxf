...
public:
    ...
    std::string fromUtf8String(std::string t) {
        return encoder.fromUtf8(t);
    }
    ...
    void setVersion(std::string *v) {
        encoder.setVersion(v);
    }
    void setCodePage(std::string *c) {
        encoder.setCodePage(c);
    }
    std::string getCodePage() {
        return encoder.getCodePage();
    }
protected:
